    ...
    const messages: OpenRouterMessage[] = [
      {
        ...
        content: [
          ...
          "Allowed extracted keys: fullName, companyName, email, phone, sourceLanguage, targetLanguage, documentType, fileType, certificationRequired, deadlineIso, urgency, deliveryMethod, appointmentType, appointmentDateTimeIso, notes."
          ,
